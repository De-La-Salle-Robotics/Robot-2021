...
public class DriveTurnDrive implements IRoutine{
    private final double HEADING_CHANGE_1 = 0;
    private final double DISTANCE_CHANGE_1 = 3 * 4096;
    private final double HEADING_CHANGE_2 = 90 * 8192.0 / 360.0;
    private final double DISTANCE_CHANGE_2 = 0;
    private final double HEADING_CHANGE_3 = 0;
    private final double DISTANCE_CHANGE_3 = 3 * 4096;
    ...
    public String getName() { return "Drive Turn Drive"; }
}